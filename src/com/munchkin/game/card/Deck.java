...
public class Deck {
    ...
    public Deck() {
        deck = new ArrayList<Card>(Arrays.asList(
                ...
                new PlayerRace("Dwarf", "You can carry any number of Big items. You can have 6 card in your hand."),
                ...
                new PlayerClass("Cleric", "When it is time for you to draw a card face-up, you may instead take the top card from the appropriate discard pile. " +
                                                            "You must then discard one card from your hand. You may discard up to 3 card in combat against an Undead creature. " +
                                                            "Each discard gives you a +3 bonus."),

                new PlayerClass("Warrior", "You may discard up to 3 card in combat, each one gives you a +1 bonus. You win ties in combat."),
                ...
                new PlayerClass("Wizard", "You may discard upt o 3 card after rolling the die to Run Away; each one gives you a +1 bonus to flee. " +
                                                            "You may discard your whole hand (minimum of 3 card) to charm a single Monster instead of fighting it. " +
